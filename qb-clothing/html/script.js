  ...
  if (canChange) {
    if (hasTracker && clothingCategory == "accessory") {
      ...
      if (clothingCategory == "model") {
        ...
        $.post(
          "http://qb-clothing/setCurrentPed",
...
$(document).on("change", ".item-number", function () {
  ...
  if (hasTracker && clothingCategory == "accessory") {
    ...
    if (clothingCategory == "accessory" && inputVal == 13) {
      ...
      $.post(
        "http://qb-clothing/updateSkinOnInput",
        JSON.stringify({
          clothingType: clothingCategory,
...
QBClothing.ReloadOutfits = function (outfits) {
  ...
  $.each(outfits, function (index, outfit) {
    var elem =
      '<div class="clothing-menu-option" data-myOutfit="' +
      (index + 1) +
      '"> <div class="clothing-menu-option-header"><p>' +
      outfit.outfitname +
      '</p></div><div class="clothing-menu-myOutfit-option-button"><p>Seleccionar</p></div><div class="clothing-menu-myOutfit-option-button-remove"><p>Borrar</p></div></div>';
...
QBClothing.SetCurrentValues = function (clothingValues) {
  $.each(clothingValues, function (i, item) {
    var itemCats = $(".clothing-menu-container").find(
      '[data-type="' + i + '"]'
    );
  ...
  $.each(data.menus, function (i, menu) {
    ...
    if (menu.menu == "roomOutfits") {
      $.each(menu.outfits, function (index, outfit) {
        var elem =
          '<div class="clothing-menu-option" data-outfit="' +
          (index + 1) +
          '"> <div class="clothing-menu-option-header"><p>' +
          outfit.outfitLabel +
          '</p></div> <div class="clothing-menu-outfit-option-button"><p>Mostrar Ropa</p></div> </div>';
    ...
    if (menu.menu == "myOutfits") {
      $.each(menu.outfits, function (index, outfit) {
        var elem =
          ...
          '"> <div class="clothing-menu-option-header"><p>' +
          outfit.outfitname +
          '</p></div><div class="clothing-menu-myOutfit-option-button"><p>Selección</p></div><div class="clothing-menu-myOutfit-option-button-remove"><p>Eliminar</p></div></div>';
        $(".clothing-menu-myOutfits-container").append(elem);
...
QBClothing.SetMaxValues = function (maxValues) {
  $.each(maxValues, function (i, cat) {
    if (cat.type == "character") {
      ...
      $(headerMax).data(
        "maxTexture",
        maxValues[containers.data("type")].texture
      );

      $(itemMax).html(
        "<p>Item: " + maxValues[containers.data("type")].item + "</p>"
      );
      $(headerMax).html(
        "<p>Texture: " + maxValues[containers.data("type")].texture + "</p>"
      );
...
$(document).on("click", ".change-camera-buttonb", function (e) {
  e.preventDefault();
