...
QBCore.Commands.Add("casco", "Poner o quitar el casco", {}, false, function(source, args)
    TriggerClientEvent("qb-clothing:client:adjustfacewear", source, 1) -- Hat
end)

QBCore.Commands.Add("gafas", "Poner o quitar las gafas", {}, false, function(source, args)
	TriggerClientEvent("qb-clothing:client:adjustfacewear", source, 2)
end)

QBCore.Commands.Add("mascara", "Poner o quitar la mascara", {}, false, function(source, args)
